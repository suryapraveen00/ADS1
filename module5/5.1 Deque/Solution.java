...
class LinkedQueue {
	...
	boolean enqueue(int x) {
		...
		rear = ll.size() - 1;
		/*
		 * Iterator itr = ll.iterator(); while (itr.hasNext()) { elements+=itr.next();
...
public class Solution {
	...
	public static void main(String[] args) {
		 ...
		 * q.dequeue(); q.dequeue(); q.dequeue(); System.out.println("-------");
		 * q.enqueue(30); q.enqueue(40); q.deleteEnd(); q.addFront(60);
		 */
